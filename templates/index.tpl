...
<script type="module">
  import { setupDashboard, setColumnSize, togglePoem, setBackground } from './js/dashboard.mjs';
...
<script>
  ...
  function doLogoAnimation() {
    ...
    function rotate() {
      ...
      let value = `hue-rotate(${rotation}deg)`;

      logo.style.webkitFilter = value;
      logo.style.filter = value;
    }
