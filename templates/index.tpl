    ...
    <div class="page">
      ...
      <div class="dashboard">
        <div class="dashboard-left command">
          ...
          <button onclick="setBackground('gray')">
            Background Stairs
          </button>
        </div>
        <div class="dashboard-right command">
          <button onclick="setColumnSize(3)">
            3 Columns
          </button>
          <button onclick="setColumnSize(5)">
            5 Columns
          </button>
          <button onclick="setColumnSize(7)">
            7 Columns
          </button>
          <button onclick="setColumnSize(10)">
            10 Columns
          </button>
