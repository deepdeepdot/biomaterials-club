...
describe('slack_3_rename_files', () => {
  ...
  test('getFilenames', () => {
    ...
    let expected = ['img_9076_720.jpg', 'img_1224_720.jpg', 'img_1225_720.jpg'];
  ...
  test('getPrefixes', () => {
    ...
    let prefixes = new Set(['img_907', 'img_122', 'img_122']);
  ...
  describe('renameFiles', () => {
    ...
    test('Normal use case. folder = "./my-folder"', () => {
      ...
      expect(fs.rename).toHaveBeenNthCalledWith(
        1,
        './my-folder/img_9076_720.jpg',
        './my-folder/20230101_01.jpg',
        expect.anything()
      );
      expect(fs.rename).toHaveBeenNthCalledWith(
        2,
        './my-folder/img_1224_720.jpg',
        './my-folder/20230113_01.jpg',
        expect.anything()
      );
      expect(fs.rename).toHaveBeenNthCalledWith(
        3,
        './my-folder/img_1225_720.jpg',
        './my-folder/20230113_02.jpg',
        expect.anything()
      );
    });
